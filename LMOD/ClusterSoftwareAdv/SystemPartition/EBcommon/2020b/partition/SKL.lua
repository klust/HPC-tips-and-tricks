...
local partition = myModuleVersion() or myModuleName()
...
LmodMessage( 'DEBUG: ' .. mode() .. ' ' .. myModuleFullName() .. ': I am for the ' .. hierarchy[1] .. ' Software stack' )

whatis( 'Dummy partition module to activate the ' .. hierarchy[1] .. ' software stack on ghd ' .. partition .. ' partition and to test hierarchyA' )
...
prepend_path( 'MODULEPATH', pathJoin( mroot, 'Applications', hierarchy[1], 'partition', partition ) )
